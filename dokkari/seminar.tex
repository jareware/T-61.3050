...
training set of 42152 correctly labelled samples using k-fold crossvalidation with k=20 \cite{training_set}.
...
reduced input space.
% TODO: cite http://ranger.uta.edu/~chqding/papers/KmeansPCA1.pdf
...
use of supervised learning methods instead.
% TODO: cite http://ranger.uta.edu/~chqding/papers/KmeansPCA1.pdf
...
SVM's are described in more detail in Section \ref{ref:svmintro} below.
